...
os.environ['MSMS_BIN']= "~/Documents/bachelor_project/docker_pipeline/surfdock/surface_mesh/tools/APBS-3.4.1.Linux/bin/msms"
...
os.environ['PDB2PQR_BIN']="/Documents/bachelor_project/docker_pipeline/surfdock/surface_mesh/tools/pdb2pqr-linux-bin64-2.1.1/pdb2pqr"
if 'PDB2PQR_BIN' in os.environ:
  ...
  sys.exit(1)
os.environ['APBS_BIN']="/Documents/bachelor_project/docker_pipeline/surfdock/surface_mesh/tools/APBS-3.4.1.Linux/bin/apbs"
if 'APBS_BIN' in os.environ:
   apbs_bin = os.environ['APBS_BIN']
else:
  print("ERROR: APBS_BIN not set. Variable should point to APBS program.")
  sys.exit(1)
os.environ['MULTIVALUE_BIN']="/Documents/bachelor_project/docker_pipeline/surfdock/surface_mesh/tools/APBS-3.4.1.Linux/share/apbs/tools/bin/multivalue"
